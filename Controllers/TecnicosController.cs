...
namespace ServicosTecnicos.Controllers
{
    public class TecnicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_tecnico,nome,MyProperty,endereco")] Tecnico tecnico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_tecnico,nome,MyProperty,endereco")] Tecnico tecnico)
        {
